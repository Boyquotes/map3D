...
int main(void) {
    ...
    irr::IrrlichtDevice* device = irr::createDevice(  // creation du device
        ...
        irr::core::dimension2d<irr::u32>(800,600),    // taille fenetre 640x480p
...
//    device->setEventReceiver(new CEventReceiver()); 
  ...
  irr::scene::IMeshSceneNode *map =        // cree un scene node nomme map
    sceneManager->addMeshSceneNode (          // via le scene manager
      sceneManager->getMesh ("mapmontpel.obj"));          // en chargeant le mesh "mapmontpel.obj"
